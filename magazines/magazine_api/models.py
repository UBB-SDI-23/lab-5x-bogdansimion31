...
class Magazine(models.Model):
    ...
    publish_date = models.DateField(validators=[MinValueValidator(limit_value=date(2009, 1, 1))])
    ...
    price = models.IntegerField(default=100, validators=[MinValueValidator(1), MaxValueValidator(9999)])
